...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "opteryx.compiled.list_ops.list_allop_neq",
        "sources": [
            "opteryx/compiled/list_ops/list_allop_neq.pyx",
            "src/cpp/simd_search.cpp"
        ]
    },
    "module_name": "opteryx.compiled.list_ops.list_allop_neq"
}
END: Cython Metadata */
...
#define __PYX_HAVE__opteryx__compiled__list_ops__list_allop_neq
#define __PYX_HAVE_API__opteryx__compiled__list_ops__list_allop_neq
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "opteryx.compiled.list_ops.list_allop_neq" */
static PyArrayObject *__pyx_f_7opteryx_8compiled_8list_ops_14list_allop_neq_list_allop_neq(PyObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "opteryx.compiled.list_ops.list_allop_neq"
extern int __pyx_module_is_main_opteryx__compiled__list_ops__list_allop_neq;
int __pyx_module_is_main_opteryx__compiled__list_ops__list_allop_neq = 0;

/* Implementation of "opteryx.compiled.list_ops.list_allop_neq" */
...
static const char __pyx_k_list_allop_neq[] = "list_allop_neq";
...
static const char __pyx_k_opteryx_compiled_list_ops_list_a[] = "opteryx/compiled/list_ops/list_allop_neq.pyx";
static const char __pyx_k_opteryx_compiled_list_ops_list_a_2[] = "opteryx.compiled.list_ops.list_allop_neq";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_7opteryx_8compiled_8list_ops_14list_allop_neq_list_allop_neq(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_literal, PyArrayObject *__pyx_v_arr); /* proto */
...
typedef struct {
  ...
  PyObject *__pyx_n_s_list_allop_neq;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_s_list_allop_neq);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_s_list_allop_neq);
...
#define __pyx_n_s_list_allop_neq __pyx_mstate_global->__pyx_n_s_list_allop_neq
...
/* "opteryx/compiled/list_ops/list_allop_neq.pyx":13
 * numpy.import_array()
 * 
...
static PyObject *__pyx_pw_7opteryx_8compiled_8list_ops_14list_allop_neq_1list_allop_neq(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyArrayObject *__pyx_f_7opteryx_8compiled_8list_ops_14list_allop_neq_list_allop_neq(PyObject *__pyx_v_literal, PyArrayObject *__pyx_v_arr, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("list_allop_neq", 1);
  __pyx_pybuffer_result.pybuffer.buf = NULL;
  __pyx_pybuffer_result.refcount = 0;
  __pyx_pybuffernd_result.data = NULL;
  __pyx_pybuffernd_result.rcbuffer = &__pyx_pybuffer_result;

  /* "opteryx/compiled/list_ops/list_allop_neq.pyx":16
 *     cdef:
 *         Py_ssize_t i, j
 ...
 */
  ...
  /* "opteryx/compiled/list_ops/list_allop_neq.pyx":19
 *         numpy.ndarray row
 * 
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "opteryx/compiled/list_ops/list_allop_neq.pyx":20
 * 
 *     for i in range(arr.shape[0]):
 *         row = arr[i]             # <<<<<<<<<<<<<<
 *         if row is not None:
 ...
 */
    ...
    /* "opteryx/compiled/list_ops/list_allop_neq.pyx":21
 *     for i in range(arr.shape[0]):
 *         row = arr[i]
 *         if row is not None:             # <<<<<<<<<<<<<<
 *             for j in range(row.shape[0]):
 ...
 */
    ...
    if (__pyx_t_9) {
      ...
      /* "opteryx/compiled/list_ops/list_allop_neq.pyx":22
 *         row = arr[i]
 *         if row is not None:
 *             for j in range(row.shape[0]):             # <<<<<<<<<<<<<<
 *                 if row[j] == literal:
 *                     result[i] = False
 */
      __pyx_t_10 = (__pyx_f_5numpy_7ndarray_5shape_shape(__pyx_v_row)[0]);
      __pyx_t_11 = __pyx_t_10;
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        __pyx_v_j = __pyx_t_12;

        /* "opteryx/compiled/list_ops/list_allop_neq.pyx":23
 *         if row is not None:
 *             for j in range(row.shape[0]):
 *                 if row[j] == literal:             # <<<<<<<<<<<<<<
 *                     result[i] = False
 *                     break
 */
        __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_v_row), __pyx_v_j, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 23, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_1 = PyObject_RichCompare(__pyx_t_4, __pyx_v_literal, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_9 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely((__pyx_t_9 < 0))) __PYX_ERR(0, 23, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        if (__pyx_t_9) {

          /* "opteryx/compiled/list_ops/list_allop_neq.pyx":24
 *             for j in range(row.shape[0]):
 *                 if row[j] == literal:
 *                     result[i] = False             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
          ...
          *__Pyx_BufPtrStrided1d(npy_bool *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_result.diminfo[0].strides) = 0;

          /* "opteryx/compiled/list_ops/list_allop_neq.pyx":25
 *                 if row[j] == literal:
 *                     result[i] = False
 *                     break             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "opteryx/compiled/list_ops/list_allop_neq.pyx":27
 *                     break
 *         else:
 *             result[i] = False             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "opteryx/compiled/list_ops/list_allop_neq.pyx":29
 *             result[i] = False
 * 
 *     return result             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("opteryx.compiled.list_ops.list_allop_neq.list_allop_neq", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_result.rcbuffer->pybuffer);
...
static PyMethodDef __pyx_mdef_7opteryx_8compiled_8list_ops_14list_allop_neq_1list_allop_neq = {"list_allop_neq", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_7opteryx_8compiled_8list_ops_14list_allop_neq_1list_allop_neq, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7opteryx_8compiled_8list_ops_14list_allop_neq_1list_allop_neq(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("list_allop_neq (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_MACROS
    ...
    if (__pyx_kwds) {
      ...
      switch (__pyx_nargs) {
        ...
        if (likely((values[1] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_arr)) != 0)) {
          ...
          __Pyx_RaiseArgtupleInvalid("list_allop_neq", 1, 2, 2, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        const Py_ssize_t kwd_pos_args = __pyx_nargs;
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values + 0, kwd_pos_args, "list_allop_neq") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("list_allop_neq", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_7opteryx_8compiled_8list_ops_14list_allop_neq_list_allop_neq(__pyx_self, __pyx_v_literal, __pyx_v_arr);
...
static PyObject *__pyx_pf_7opteryx_8compiled_8list_ops_14list_allop_neq_list_allop_neq(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_literal, PyArrayObject *__pyx_v_arr) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("list_allop_neq", 1);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_7opteryx_8compiled_8list_ops_14list_allop_neq_list_allop_neq(__pyx_v_literal, __pyx_v_arr, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_n_s_list_allop_neq, __pyx_k_list_allop_neq, sizeof(__pyx_k_list_allop_neq), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__5 = (PyObject*)__Pyx_PyCode_New(2, 0, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__4, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_opteryx_compiled_list_ops_list_a, __pyx_n_s_list_allop_neq, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__5)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_list_allop_neq(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_list_allop_neq},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initlist_allop_neq(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initlist_allop_neq(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_list_allop_neq(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_list_allop_neq(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_list_allop_neq(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'list_allop_neq' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("list_allop_neq", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  if (unlikely(!__pyx_m)) __PYX_ERR(0, 1, __pyx_L1_error)
  #elif CYTHON_USE_MODULE_STATE
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  {
    int add_module_result = PyState_AddModule(__pyx_t_1, &__pyx_moduledef);
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "list_allop_neq" pseudovariable */
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_list_allop_neq(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_opteryx__compiled__list_ops__list_allop_neq) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "opteryx.compiled.list_ops.list_allop_neq")) {
      if (unlikely((PyDict_SetItemString(modules, "opteryx.compiled.list_ops.list_allop_neq", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "opteryx/compiled/list_ops/list_allop_neq.pyx":9
 ...
 */
  ...
  /* "opteryx/compiled/list_ops/list_allop_neq.pyx":11
 * import numpy
 * cimport numpy
 * numpy.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *         Py_ssize_t i, j
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_7opteryx_8compiled_8list_ops_14list_allop_neq_1list_allop_neq, 0, __pyx_n_s_list_allop_neq, NULL, __pyx_n_s_opteryx_compiled_list_ops_list_a_2, __pyx_d, ((PyObject *)__pyx_codeobj__5)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_list_allop_neq, __pyx_t_2) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "opteryx/compiled/list_ops/list_allop_neq.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init opteryx.compiled.list_ops.list_allop_neq", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init opteryx.compiled.list_ops.list_allop_neq");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
