 ...
 *             result[i] = None
*/
      __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_sub_array, __pyx_v_key, int, 1, __Pyx_PyLong_From_int, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      if (unlikely((__Pyx_SetItemInt(((PyObject *)__pyx_v_result), __pyx_v_i, __pyx_t_2, Py_ssize_t, 1, PyLong_FromSsize_t, 0, 0, 0) < 0))) __PYX_ERR(0, 41, __pyx_L1_error)
