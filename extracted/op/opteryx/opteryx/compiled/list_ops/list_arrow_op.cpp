...
*/
        ...
        __Pyx_GOTREF(__pyx_t_2);
        if (unlikely((__Pyx_SetItemInt(((PyObject *)__pyx_v_result), __pyx_v_i, __pyx_t_2, Py_ssize_t, 1, PyLong_FromSsize_t, 0, 0, 0) < 0))) __PYX_ERR(0, 40, __pyx_L1_error)
...
*/
      /*else*/ {
        if (unlikely((__Pyx_SetItemInt(((PyObject *)__pyx_v_result), __pyx_v_i, Py_None, Py_ssize_t, 1, PyLong_FromSsize_t, 0, 0, 0) < 0))) __PYX_ERR(0, 43, __pyx_L1_error)
      }
      __pyx_L6:;
