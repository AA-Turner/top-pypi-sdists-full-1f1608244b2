...
class _Singleton(object):
    ...
    def _start_trigger_services(self, _enable_monitor=False):
    ...
    def connect(self, token, host, port, proxy, tags=None, labels=None, async_start=False, fork=False, debug=False,
                _enable_monitor=False, throw_errors=False):
        ...
        self._start_trigger_services(_enable_monitor=_enable_monitor)
