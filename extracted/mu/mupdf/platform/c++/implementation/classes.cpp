...
/* Class-aware wrapper for `::fz_new_display_list_from_svg()`.
	 ...
	 */
FZ_FUNCTION FzDisplayList FzBuffer::fz_new_display_list_from_svg(const char *base_uri, const FzArchive& zip, float *w, float *h) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::fz_new_display_list_from_svg(*this, base_uri, zip, w, h);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzBuffer_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION FzImage FzBuffer::fz_new_image_from_svg(const char *base_uri, const FzArchive& zip) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::fz_new_image_from_svg(*this, base_uri, zip);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzBuffer_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfProcessor FzBuffer::pdf_new_buffer_processor(int ahxencode) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_buffer_processor(*this, ahxencode);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzBuffer_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfProcessor FzDevice::pdf_new_run_processor(const FzMatrix& ctm, const char *usage, const PdfGstate& gstate, const FzDefaultColorspaces& default_cs, FzCookie& cookie) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_run_processor(*this, ctm, usage, gstate, default_cs, cookie);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzDevice_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION FzDevice2::FzDevice2()
{
	...
	m_internal = ll_fz_new_device_of_size(sizeof(*m_internal) + sizeof(FzDevice2*));
...
static void FzDevice2_s_close_device(::fz_context *arg_0, ::fz_device *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_close_device(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_close_device(): exception: " << e.what() << "\n";
		}
		#endif
...
static void FzDevice2_s_drop_device(::fz_context *arg_0, ::fz_device *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_drop_device(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_drop_device(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_fill_path(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_path *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_path(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_path(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_stroke_path(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_path *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_stroke_path(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_stroke_path(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_clip_path(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_path *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_rect arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_path(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_path(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_clip_stroke_path(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_path *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_rect arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_stroke_path(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_stroke_path(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_fill_text(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_text *arg_2, ::fz_matrix arg_3, ::fz_colorspace *arg_4, const float *arg_5, float arg_6, ::fz_color_params arg_7)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_text(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_text(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_stroke_text(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_text *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_stroke_text(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_stroke_text(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_clip_text(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_text *arg_2, ::fz_matrix arg_3, ::fz_rect arg_4)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_text(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_text(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_clip_stroke_text(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_text *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_rect arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_stroke_text(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_stroke_text(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_ignore_text(::fz_context *arg_0, ::fz_device *arg_1, const ::fz_text *arg_2, ::fz_matrix arg_3)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_ignore_text(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_ignore_text(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_fill_shade(::fz_context *arg_0, ::fz_device *arg_1, ::fz_shade *arg_2, ::fz_matrix arg_3, float arg_4, ::fz_color_params arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_shade(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_shade(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_fill_image(::fz_context *arg_0, ::fz_device *arg_1, ::fz_image *arg_2, ::fz_matrix arg_3, float arg_4, ::fz_color_params arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_image(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_image(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_fill_image_mask(::fz_context *arg_0, ::fz_device *arg_1, ::fz_image *arg_2, ::fz_matrix arg_3, ::fz_colorspace *arg_4, const float *arg_5, float arg_6, ::fz_color_params arg_7)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_image_mask(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_fill_image_mask(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_clip_image_mask(::fz_context *arg_0, ::fz_device *arg_1, ::fz_image *arg_2, ::fz_matrix arg_3, ::fz_rect arg_4)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_image_mask(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_clip_image_mask(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_pop_clip(::fz_context *arg_0, ::fz_device *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_pop_clip(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_pop_clip(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_begin_mask(::fz_context *arg_0, ::fz_device *arg_1, ::fz_rect arg_2, int arg_3, ::fz_colorspace *arg_4, const float *arg_5, ::fz_color_params arg_6)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_mask(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_mask(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_end_mask(::fz_context *arg_0, ::fz_device *arg_1)
{
	FzDevice2* self = (*(FzDevice2**) (arg_1 + 1));
	#ifndef NDEBUG
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_mask(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
		return self->end_mask(arg_0);
	}
	catch (std::exception& e)
	{
		#ifndef NDEBUG
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_mask(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_begin_group(::fz_context *arg_0, ::fz_device *arg_1, ::fz_rect arg_2, ::fz_colorspace *arg_3, int arg_4, int arg_5, int arg_6, float arg_7)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_group(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_group(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_end_group(::fz_context *arg_0, ::fz_device *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_group(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_group(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static int FzDevice2_s_begin_tile(::fz_context *arg_0, ::fz_device *arg_1, ::fz_rect arg_2, ::fz_rect arg_3, float arg_4, float arg_5, ::fz_matrix arg_6, int arg_7)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_tile(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_tile(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_end_tile(::fz_context *arg_0, ::fz_device *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_tile(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_tile(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_render_flags(::fz_context *arg_0, ::fz_device *arg_1, int arg_2, int arg_3)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_render_flags(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_render_flags(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_set_default_colorspaces(::fz_context *arg_0, ::fz_device *arg_1, ::fz_default_colorspaces *arg_2)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_set_default_colorspaces(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_set_default_colorspaces(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_begin_layer(::fz_context *arg_0, ::fz_device *arg_1, const char *arg_2)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_layer(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_begin_layer(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzDevice2_s_end_layer(::fz_context *arg_0, ::fz_device *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_layer(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzDevice2_s_end_layer(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
FZ_FUNCTION void FzDevice2::close_device(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::close_device().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::drop_device(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::drop_device().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::fill_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, int arg_3, ::fz_matrix arg_4, struct ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::fill_path().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::stroke_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, struct ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::stroke_path().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::clip_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_rect arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::clip_path().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::clip_stroke_path(struct ::fz_context *arg_0, const struct ::fz_path *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_rect arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::clip_stroke_path().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::fill_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, ::fz_matrix arg_3, struct ::fz_colorspace *arg_4, const float *arg_5, float arg_6, ::fz_color_params arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::fill_text().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::stroke_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, struct ::fz_colorspace *arg_5, const float *arg_6, float arg_7, ::fz_color_params arg_8)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::stroke_text().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::clip_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, ::fz_matrix arg_3, ::fz_rect arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::clip_text().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::clip_stroke_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, const ::fz_stroke_state *arg_3, ::fz_matrix arg_4, ::fz_rect arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::clip_stroke_text().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::ignore_text(struct ::fz_context *arg_0, const ::fz_text *arg_2, ::fz_matrix arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::ignore_text().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::fill_shade(struct ::fz_context *arg_0, ::fz_shade *arg_2, ::fz_matrix arg_3, float arg_4, ::fz_color_params arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::fill_shade().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::fill_image(struct ::fz_context *arg_0, struct ::fz_image *arg_2, ::fz_matrix arg_3, float arg_4, ::fz_color_params arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::fill_image().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::fill_image_mask(struct ::fz_context *arg_0, struct ::fz_image *arg_2, ::fz_matrix arg_3, struct ::fz_colorspace *arg_4, const float *arg_5, float arg_6, ::fz_color_params arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::fill_image_mask().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::clip_image_mask(struct ::fz_context *arg_0, struct ::fz_image *arg_2, ::fz_matrix arg_3, ::fz_rect arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::clip_image_mask().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::pop_clip(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::pop_clip().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::begin_mask(struct ::fz_context *arg_0, ::fz_rect arg_2, int arg_3, struct ::fz_colorspace *arg_4, const float *arg_5, ::fz_color_params arg_6)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::begin_mask().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::end_mask(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::end_mask().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::begin_group(struct ::fz_context *arg_0, ::fz_rect arg_2, struct ::fz_colorspace *arg_3, int arg_4, int arg_5, int arg_6, float arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::begin_group().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::end_group(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::end_group().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION int FzDevice2::begin_tile(struct ::fz_context *arg_0, ::fz_rect arg_2, ::fz_rect arg_3, float arg_4, float arg_5, ::fz_matrix arg_6, int arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::begin_tile().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::end_tile(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::end_tile().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::render_flags(struct ::fz_context *arg_0, int arg_2, int arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::render_flags().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::set_default_colorspaces(struct ::fz_context *arg_0, ::fz_default_colorspaces *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::set_default_colorspaces().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::begin_layer(struct ::fz_context *arg_0, const char *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzDevice2::begin_layer().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzDevice2::end_layer(struct ::fz_context *arg_0)
{
...
FZ_FUNCTION FzDisplayList::FzDisplayList(const FzBuffer& buf, const char *base_uri, const FzArchive& zip, float *w, float *h)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_fz_new_display_list_from_svg(buf.m_internal, base_uri, zip.m_internal, w, h);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzDisplayList_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION FzDisplayList::FzDisplayList(const FzXml& xmldoc, const FzXml& xml, const char *base_uri, const FzArchive& zip, float *w, float *h)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_fz_new_display_list_from_svg_xml(xmldoc.m_internal, xml.m_internal, base_uri, zip.m_internal, w, h);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzDisplayList_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION ::fz_bookmark FzDocument::fz_make_bookmark(const FzLocation& loc) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::fz_make_bookmark(*this, loc);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
/** Custom method. */
FZ_FUNCTION std::string FzDocument::fz_lookup_metadata(const char* key, int* o_out)
{
	return ll_fz_lookup_metadata(m_internal, key, o_out);
}
...
FZ_FUNCTION void FzDocumentWriter::fz_write_stabilized_story(const char *user_css, float em, ::fz_write_story_contentfn contentfn, void *contentfn_ref, ::fz_write_story_rectfn rectfn, void *rectfn_ref, ::fz_write_story_pagefn pagefn, void *pagefn_ref, const FzArchive& archive) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::fz_write_stabilized_story(*this, user_css, em, contentfn, contentfn_ref, rectfn, rectfn_ref, pagefn, pagefn_ref, archive);
}

/* Class-aware wrapper for `::fz_write_story()`.  */
FZ_FUNCTION void FzDocumentWriter::fz_write_story(const FzStoryS& story, ::fz_write_story_rectfn rectfn, void *rectfn_ref, ::fz_write_story_positionfn positionfn, void *positionfn_ref, ::fz_write_story_pagefn pagefn, void *pagefn_ref) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION FzImage::FzImage(int w, int h, int bpc, const FzColorspace& colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, const FzCompressedBuffer& buffer, const FzImage& mask)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION FzImage::FzImage(const FzBuffer& buf, const char *base_uri, const FzArchive& zip)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_fz_new_image_from_svg(buf.m_internal, base_uri, zip.m_internal);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzImage_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION FzImage::FzImage(const FzXml& xmldoc, const FzXml& xml, const char *base_uri, const FzArchive& zip)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_fz_new_image_from_svg_xml(xmldoc.m_internal, xml.m_internal, base_uri, zip.m_internal);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzImage_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION FzImage::FzImage(int w, int h, int bpc, const FzColorspace& colorspace, int xres, int yres, int interpolate, int imagemask, float *decode, int *colorkey, const FzImage& mask, size_t size, ::fz_image_get_pixmap_fn *get_pixmap, ::fz_image_get_size_fn *get_size, ::fz_drop_image_fn *drop)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION int FzImage::n()
{
	return m_internal->n;
}

FZ_FUNCTION int FzImage::bpc()
{
...
FZ_FUNCTION unsigned int FzImage::invert_cmyk_jpeg()
{
...
FZ_FUNCTION int FzImage::orientation()
{
...
FZ_FUNCTION char *FzLinkDest::pdf_format_link_uri() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_format_link_uri(*this);
	return ret;
}
...
FZ_FUNCTION std::vector<unsigned char> FzMd5::fz_md5_final2()
{
	...
	ll_fz_md5_final( &m_internal, &ret[0]);
	return ret;
}
...
FZ_FUNCTION PdfProcessor FzOutput::pdf_new_output_processor(int ahxencode) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_output_processor(*this, ahxencode);
	return ret;
}
...
FZ_FUNCTION void FzOutput::pdf_print_encrypted_obj(const PdfObj& obj, int tight, int ascii, const PdfCrypt& crypt, int num, int gen) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::pdf_print_encrypted_obj(*this, obj, tight, ascii, crypt, num, gen);
}
...
static void FzOutput2_s_write(::fz_context *arg_0, void *arg_1, const void *arg_2, size_t arg_3)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_write(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_write(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzOutput2_s_seek(::fz_context *arg_0, void *arg_1, int64_t arg_2, int arg_3)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_seek(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_seek(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static int64_t FzOutput2_s_tell(::fz_context *arg_0, void *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_tell(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_tell(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzOutput2_s_close(::fz_context *arg_0, void *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_close(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_close(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzOutput2_s_drop(::fz_context *arg_0, void *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_drop(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_drop(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static ::fz_stream * FzOutput2_s_as_stream(::fz_context *arg_0, void *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_as_stream(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_as_stream(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzOutput2_s_truncate(::fz_context *arg_0, void *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_truncate(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzOutput2_s_truncate(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
/** Custom method. */
FZ_FUNCTION std::vector<FzQuad> FzPage::fz_search_page(const char* needle, int *hit_mark, int max)
{
	std::vector<FzQuad> ret(max);
	::fz_quad* hit_bbox = ret[0].internal();
	int n = ll_fz_search_page(m_internal, needle, hit_mark, hit_bbox, (int) ret.size());
	ret.resize(n);
	return ret;
}
...
FZ_FUNCTION FzPathWalker2::FzPathWalker2()
{
	...
	m_internal = (::fz_path_walker*) ll_fz_calloc(1, sizeof(*m_internal) + sizeof(FzPathWalker2*));
...
static void FzPathWalker2_s_moveto(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_moveto(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_moveto(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_lineto(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_lineto(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_lineto(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_curveto(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_curveto(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_curveto(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_closepath(::fz_context *arg_0, void *arg_1)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_closepath(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_closepath(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_quadto(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_quadto(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_quadto(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_curvetov(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_curvetov(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_curvetov(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_curvetoy(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_curvetoy(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_curvetoy(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void FzPathWalker2_s_rectto(::fz_context *arg_0, void *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	if (s_trace_director)
	{
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_rectto(): arg_1=" << arg_1 << " self=" << self << "\n";
	}
	#endif
	try
	{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": FzPathWalker2_s_rectto(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::moveto(struct ::fz_context *arg_0, float arg_2, float arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::moveto().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::lineto(struct ::fz_context *arg_0, float arg_2, float arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::lineto().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::curveto(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::curveto().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::closepath(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::closepath().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::quadto(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::quadto().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::curvetov(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::curvetov().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::curvetoy(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn FzPathWalker2::curvetoy().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void FzPathWalker2::rectto(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
...
/** Custom method. */
FZ_FUNCTION std::vector<unsigned char> FzPixmap::fz_md5_pixmap()
{
	std::vector<unsigned char>  ret(16);
	ll_fz_md5_pixmap( m_internal, &ret[0]);
	return ret;
}

/** Custom method. */
FZ_FUNCTION long long FzPixmap::fz_pixmap_samples_int()
{
...
/** Custom method. */
FZ_FUNCTION int FzPixmap::fz_samples_get(int offset)
{
	return m_internal->samples[offset];
}

/** Custom method. */
FZ_FUNCTION void FzPixmap::fz_samples_set(int offset, int value)
{
...
FZ_FUNCTION ptrdiff_t FzPixmap::stride()
{
	return m_internal->stride;
}
...
FZ_FUNCTION FzStoryElementPosition::FzStoryElementPosition(::fz_story_element_position* internal)
: m_internal(internal)
{
}

/** Custom method. */
FZ_FUNCTION long long FzStoryElementPosition::m_internal_value()
{
	return (uintptr_t) m_internal;
}


/* Implementation of methods for FzStoryS (wrapper for fz_story_s). */

/* Constructor using `fz_new_story()`. */
FZ_FUNCTION FzStoryS::FzStoryS(const FzBuffer& buf, const char *user_css, float em, const FzArchive& archive)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_fz_new_story(buf.m_internal, user_css, em, archive.m_internal);
}

/* Class-aware wrapper for `::fz_draw_story()`.  */
FZ_FUNCTION void FzStoryS::fz_draw_story(const FzDevice& dev, const FzMatrix& ctm) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION int FzStoryS::fz_place_story(const FzRect& where, FzRect& filled) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION void FzStoryS::fz_reset_story() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION FzXml FzStoryS::fz_story_document() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION void FzStoryS::fz_story_positions(::fz_story_position_callback *cb, void *arg) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION const char *FzStoryS::fz_story_warnings() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION FzStoryS::FzStoryS(::fz_story_s* internal)
: m_internal(internal)
{
}

/** Custom method. */
FZ_FUNCTION long long FzStoryS::m_internal_value()
{
	return (uintptr_t) m_internal;
}
...
FZ_FUNCTION FzStream FzStream::fz_open_dctd(int color_transform, int l2factor, const FzStream& jpegtables) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::fz_open_dctd(*this, color_transform, l2factor, jpegtables);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzStream_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
/* Class-aware wrapper for `::fz_new_display_list_from_svg_xml()`.
	 ...
	 */
FZ_FUNCTION FzDisplayList FzXml::fz_new_display_list_from_svg_xml(const FzXml& xml, const char *base_uri, const FzArchive& zip, float *w, float *h) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::fz_new_display_list_from_svg_xml(*this, xml, base_uri, zip, w, h);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzXml_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION FzImage FzXml::fz_new_image_from_svg_xml(const FzXml& xml, const char *base_uri, const FzArchive& zip) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::fz_new_image_from_svg_xml(*this, xml, base_uri, zip);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_FzXml_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION char *PdfCrypt::pdf_crypt_method() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION void PdfDocument::pdf_filter_annot_contents(const PdfAnnot& annot, PdfFilterOptions& filter) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::pdf_filter_annot_contents(*this, annot, filter);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION void PdfDocument::pdf_filter_page_contents(const PdfPage& page, PdfFilterOptions& filter) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::pdf_filter_page_contents(*this, page, filter);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
/* Class-aware wrapper for `::pdf_lookup_anchor()`.
	 ...
	 */
FZ_FUNCTION int PdfDocument::pdf_lookup_anchor(const char *name, float *xp, float *yp) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_lookup_anchor(*this, name, xp, yp);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfObj PdfDocument::pdf_new_destination_from_link(const char *uri) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_destination_from_link(*this, uri);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
/* Class-aware wrapper for `::pdf_new_filter_processor()`.  */
FZ_FUNCTION PdfProcessor PdfDocument::pdf_new_filter_processor(const PdfProcessor& chain, const PdfObj& old_res, const PdfObj& new_res, int struct_parents, const FzMatrix& transform, PdfFilterOptions& filter) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_new_filter_processor()\n";
	}
	#endif
	auto ret = mupdf::pdf_new_filter_processor(*this, chain, old_res, new_res, struct_parents, transform, filter);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION char *PdfDocument::pdf_parse_link_action(const PdfObj& obj, int pagenum) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_parse_link_action(*this, obj, pagenum);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION char *PdfDocument::pdf_parse_link_dest(const PdfObj& obj) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_parse_link_dest(*this, obj);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfDocument_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
/* Class-aware wrapper for `::pdf_repair_obj()`.
	...
	This method has out-params. Python/C# wrappers look like:
		`pdf_repair_obj(::pdf_lexbuf *buf, ::pdf_obj **encrypt, ::pdf_obj **id, ::pdf_obj **page, ::pdf_obj **root)` => `(int, int64_t stmofsp, int stmlenp, int64_t tmpofs)`
	 */
FZ_FUNCTION int PdfDocument::pdf_repair_obj(const PdfLexbuf& buf, int64_t *stmofsp, int *stmlenp, PdfObj& encrypt, PdfObj& id, PdfObj& page, int64_t *tmpofs, PdfObj& root) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
/** Custom method. */
FZ_FUNCTION std::string PdfDocument::pdf_lookup_metadata(const char* key, int* o_out)
{
	return ll_pdf_lookup_metadata(m_internal, key, o_out);
}
...
static ::fz_image * PdfFilterOptions2_s_image_filter(::fz_context *arg_0, void *arg_1, ::fz_matrix arg_2, const char *arg_3, ::fz_image *arg_4)
{
	...
	try
	{
		return self->image_filter(arg_0, arg_2, arg_3, arg_4);
	}
	catch (std::exception& e)
	{
		#ifndef NDEBUG
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfFilterOptions2_s_image_filter(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static int PdfFilterOptions2_s_text_filter(::fz_context *arg_0, void *arg_1, int *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_matrix arg_5, ::fz_rect arg_6)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfFilterOptions2_s_text_filter(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfFilterOptions2_s_after_text_object(::fz_context *arg_0, void *arg_1, ::pdf_document *arg_2, ::pdf_processor *arg_3, ::fz_matrix arg_4)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfFilterOptions2_s_after_text_object(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfFilterOptions2_s_end_page(::fz_context *arg_0, ::fz_buffer *arg_1, void *arg_2)
{
	...
	try
	{
		return self->end_page(arg_0, arg_2);
	}
	catch (std::exception& e)
	{
		#ifndef NDEBUG
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfFilterOptions2_s_end_page(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
/* Default implementation of virtual method. */
FZ_FUNCTION struct ::fz_image * PdfFilterOptions2::image_filter(struct ::fz_context *arg_0, ::fz_matrix arg_2, const char *arg_3, struct ::fz_image *arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfFilterOptions2::image_filter().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION int PdfFilterOptions2::text_filter(struct ::fz_context *arg_0, int *arg_2, int arg_3, ::fz_matrix arg_4, ::fz_matrix arg_5, ::fz_rect arg_6)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfFilterOptions2::text_filter().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfFilterOptions2::after_text_object(struct ::fz_context *arg_0, struct ::pdf_document *arg_2, struct ::pdf_processor *arg_3, ::fz_matrix arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfFilterOptions2::after_text_object().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfFilterOptions2::end_page(struct ::fz_context *arg_0, void *arg_2)
{
...
FZ_FUNCTION ptrdiff_t PdfLexbuf::pdf_lexbuf_grow() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
...
FZ_FUNCTION PdfObj::PdfObj(const PdfDocument& doc, const char *uri)
{
	...
	#endif
	this->m_internal = ll_pdf_new_destination_from_link(doc.m_internal, uri);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfObj_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
/* Class-aware wrapper for `::pdf_new_action_from_link()`.  */
FZ_FUNCTION PdfObj PdfObj::pdf_new_action_from_link(const PdfDocument& doc, const char *uri)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_action_from_link(doc, uri);
	return ret;
}
...
/* Class-aware wrapper for `::pdf_field_name()`.  */
FZ_FUNCTION char *PdfObj::pdf_field_name() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
				<< " calling mupdf::ll_pdf_field_name()\n";
	}
	#endif
	auto ret = mupdf::pdf_field_name(*this);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfObj_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfObj PdfObj::pdf_filter_xobject_instance(const PdfObj& page_res, const FzMatrix& ctm, PdfFilterOptions& filter, const PdfCycleList& cycle_up) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_filter_xobject_instance(*this, page_res, ctm, filter, cycle_up);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfObj_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION void PdfObj::pdf_page_obj_transform(FzRect& page_mediabox, FzMatrix& page_ctm) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::pdf_page_obj_transform(*this, page_mediabox, page_ctm);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfObj_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
/** Custom method. */
FZ_FUNCTION std::string PdfObj::pdf_field_name2()
{
	return mupdf::pdf_field_name2( *this);
}
...
FZ_FUNCTION FzRect PdfPage::pdf_bound_page() const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_bound_page(*this);
	return ret;
}
...
FZ_FUNCTION FzPixmap PdfPage::pdf_new_pixmap_from_page_contents_with_separations_and_usage(const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_pixmap_from_page_contents_with_separations_and_usage(*this, ctm, cs, seps, alpha, usage);
	return ret;
}

/* Class-aware wrapper for `::pdf_new_pixmap_from_page_contents_with_usage()`.  */
FZ_FUNCTION FzPixmap PdfPage::pdf_new_pixmap_from_page_contents_with_usage(const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_pixmap_from_page_contents_with_usage(*this, ctm, cs, alpha, usage);
	return ret;
}

/* Class-aware wrapper for `::pdf_new_pixmap_from_page_with_separations_and_usage()`.  */
FZ_FUNCTION FzPixmap PdfPage::pdf_new_pixmap_from_page_with_separations_and_usage(const FzMatrix& ctm, const FzColorspace& cs, const FzSeparations& seps, int alpha, const char *usage) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_pixmap_from_page_with_separations_and_usage(*this, ctm, cs, seps, alpha, usage);
	return ret;
}

/* Class-aware wrapper for `::pdf_new_pixmap_from_page_with_usage()`.  */
FZ_FUNCTION FzPixmap PdfPage::pdf_new_pixmap_from_page_with_usage(const FzMatrix& ctm, const FzColorspace& cs, int alpha, const char *usage) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_new_pixmap_from_page_with_usage(*this, ctm, cs, alpha, usage);
	return ret;
}
...
FZ_FUNCTION int PdfPkcs7Verifier::pdf_check_signature(const PdfDocument& doc, const PdfObj& signature, char *ebuf, size_t ebufsize) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	auto ret = mupdf::pdf_check_signature(*this, doc, signature, ebuf, ebufsize);
	return ret;
}
...
FZ_FUNCTION PdfProcessor::PdfProcessor(const FzBuffer& buffer, int ahxencode)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_pdf_new_buffer_processor(buffer.m_internal, ahxencode);
	#ifndef NDEBUG
	if (s_check_refs)
	{
...
FZ_FUNCTION PdfProcessor::PdfProcessor(const PdfDocument& doc, const PdfProcessor& chain, const PdfObj& old_res, const PdfObj& new_res, int struct_parents, const FzMatrix& transform, PdfFilterOptions& filter)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_pdf_new_filter_processor(doc.m_internal, chain.m_internal, old_res.m_internal, new_res.m_internal, struct_parents, * transform.internal(),  filter.internal());
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfProcessor_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfProcessor::PdfProcessor(const FzOutput& out, int ahxencode)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_pdf_new_output_processor(out.m_internal, ahxencode);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfProcessor_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfProcessor::PdfProcessor(const FzDevice& dev, const FzMatrix& ctm, const char *usage, const PdfGstate& gstate, const FzDefaultColorspaces& default_cs, FzCookie& cookie)
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	this->m_internal = ll_pdf_new_run_processor(dev.m_internal, * ctm.internal(), usage, gstate.m_internal, default_cs.m_internal, &cookie.m_internal);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfProcessor_refs_check.add( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION void PdfProcessor::pdf_process_contents(const PdfDocument& doc, const PdfObj& obj, const PdfObj& res, FzCookie& cookie) const
{
	#ifndef NDEBUG
	if (s_trace) {
		std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << "():"
	...
	#endif
	mupdf::pdf_process_contents(*this, doc, obj, res, cookie);
	#ifndef NDEBUG
	if (s_check_refs)
	{
		s_PdfProcessor_refs_check.check( this, __FILE__, __LINE__, __FUNCTION__);
...
FZ_FUNCTION PdfProcessor2::PdfProcessor2()
{
	...
	m_internal = (::pdf_processor*) ll_pdf_new_processor(sizeof(*m_internal) + sizeof(PdfProcessor2*));
...
static void PdfProcessor2_s_close_processor(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_close_processor(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_drop_processor(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_drop_processor(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_w(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_w(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_j(::fz_context *arg_0, ::pdf_processor *arg_1, int arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_j(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_M(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_M(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_d(::fz_context *arg_0, ::pdf_processor *arg_1, ::pdf_obj *arg_2, float arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_d(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_ri(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_ri(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_i(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_i(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_begin(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::pdf_obj *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_begin(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_BM(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_BM(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_ca(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_ca(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_SMask(::fz_context *arg_0, ::pdf_processor *arg_1, ::pdf_obj *arg_2, ::pdf_obj *arg_3, float *arg_4, int arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_SMask(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_end(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_end(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_q(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_q(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_cm(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_cm(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_l(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_l(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_c(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_c(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_v(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_v(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_y(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_y(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_h(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_h(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_re(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_re(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_S(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_S(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_F(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_F(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_fstar(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_fstar(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_B(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_B(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Bstar(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Bstar(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_n(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_n(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Wstar(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Wstar(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_BT(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_BT(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_ET(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_ET(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tc(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tc(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tw(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tw(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tz(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tz(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_TL(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_TL(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tf(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::pdf_font_desc *arg_3, float arg_4)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tf(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tr(::fz_context *arg_0, ::pdf_processor *arg_1, int arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tr(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Ts(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Ts(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Td(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Td(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tm(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tm(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Tstar(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Tstar(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_TJ(::fz_context *arg_0, ::pdf_processor *arg_1, ::pdf_obj *arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_TJ(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_squote(::fz_context *arg_0, ::pdf_processor *arg_1, char *arg_2, size_t arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_squote(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_dquote(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, char *arg_4, size_t arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_dquote(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_d0(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_d0(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_d1(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_d1(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_CS(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::fz_colorspace *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_CS(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_SC_pattern(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::pdf_pattern *arg_3, int arg_4, float *arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_SC_pattern(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_SC_shade(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::fz_shade *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_SC_shade(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_SC_color(::fz_context *arg_0, ::pdf_processor *arg_1, int arg_2, float *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_SC_color(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_G(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_G(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_RG(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_RG(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_K(::fz_context *arg_0, ::pdf_processor *arg_1, float arg_2, float arg_3, float arg_4, float arg_5)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_K(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_BI(::fz_context *arg_0, ::pdf_processor *arg_1, ::fz_image *arg_2, const char *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_BI(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_sh(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::fz_shade *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_sh(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Do_image(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::fz_image *arg_3)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Do_image(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_Do_form(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::pdf_obj *arg_3, ::pdf_obj *arg_4)
{
	...
	try
	{
		return self->op_Do_form(arg_0, arg_2, arg_3, arg_4);
	}
	catch (std::exception& e)
	{
		#ifndef NDEBUG
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_Do_form(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_MP(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_MP(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_DP(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::pdf_obj *arg_3, ::pdf_obj *arg_4)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_DP(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_BMC(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_BMC(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_BDC(::fz_context *arg_0, ::pdf_processor *arg_1, const char *arg_2, ::pdf_obj *arg_3, ::pdf_obj *arg_4)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_BDC(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_EMC(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_EMC(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_BX(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_BX(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_EX(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_EX(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_OP(::fz_context *arg_0, ::pdf_processor *arg_1, int arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_OP(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_OPM(::fz_context *arg_0, ::pdf_processor *arg_1, int arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_OPM(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_gs_UseBlackPtComp(::fz_context *arg_0, ::pdf_processor *arg_1, ::pdf_obj *arg_2)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_gs_UseBlackPtComp(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
static void PdfProcessor2_s_op_END(::fz_context *arg_0, ::pdf_processor *arg_1)
{
	...
	catch (std::exception& e)
	{
		...
		if (s_trace_director)
		{
			std::cerr << __FILE__ << ":" << __LINE__ << ":" << __FUNCTION__ << ": PdfProcessor2_s_op_END(): exception: " << e.what() << "\n";
		}
		#endif
		fz_throw(arg_0, FZ_ERROR_GENERIC, "%s", e.what());
	}
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_M(struct ::fz_context *arg_0, float arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_M().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_d(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2, float arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_d().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_ri(struct ::fz_context *arg_0, const char *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_ri().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_i(struct ::fz_context *arg_0, float arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_i().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_begin(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_gs_begin().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_BM(struct ::fz_context *arg_0, const char *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_gs_BM().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_ca(struct ::fz_context *arg_0, float arg_2)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_SMask(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2, struct ::pdf_obj *arg_3, float *arg_4, int arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_gs_SMask().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_end(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_gs_end().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_q(struct ::fz_context *arg_0)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_cm(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_cm().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_m(struct ::fz_context *arg_0, float arg_2, float arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_m().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_l(struct ::fz_context *arg_0, float arg_2, float arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_l().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_c(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_c().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_v(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_v().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_y(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_y().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_h(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_h().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_re(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_re().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_S(struct ::fz_context *arg_0)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_F(struct ::fz_context *arg_0)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_Tm(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_Tm().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_Tstar(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_Tstar().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_TJ(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_TJ().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_Tj(struct ::fz_context *arg_0, char *arg_2, unsigned long arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_Tj().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_squote(struct ::fz_context *arg_0, char *arg_2, unsigned long arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_squote().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_dquote(struct ::fz_context *arg_0, float arg_2, float arg_3, char *arg_4, unsigned long arg_5)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_dquote().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_d0(struct ::fz_context *arg_0, float arg_2, float arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_d0().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_d1(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5, float arg_6, float arg_7)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_d1().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_CS(struct ::fz_context *arg_0, const char *arg_2, struct ::fz_colorspace *arg_3)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_SC_pattern(struct ::fz_context *arg_0, const char *arg_2, ::pdf_pattern *arg_3, int arg_4, float *arg_5)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_SC_shade(struct ::fz_context *arg_0, const char *arg_2, ::fz_shade *arg_3)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_SC_color(struct ::fz_context *arg_0, int arg_2, float *arg_3)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_G(struct ::fz_context *arg_0, float arg_2)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_RG(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_K(struct ::fz_context *arg_0, float arg_2, float arg_3, float arg_4, float arg_5)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_BI(struct ::fz_context *arg_0, struct ::fz_image *arg_2, const char *arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_BI().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_sh(struct ::fz_context *arg_0, const char *arg_2, ::fz_shade *arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_sh().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_Do_image(struct ::fz_context *arg_0, const char *arg_2, struct ::fz_image *arg_3)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_Do_image().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_Do_form(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3, struct ::pdf_obj *arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_Do_form().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_MP(struct ::fz_context *arg_0, const char *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_MP().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_DP(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3, struct ::pdf_obj *arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_DP().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_BMC(struct ::fz_context *arg_0, const char *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_BMC().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_BDC(struct ::fz_context *arg_0, const char *arg_2, struct ::pdf_obj *arg_3, struct ::pdf_obj *arg_4)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_BDC().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_EMC(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_EMC().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_BX(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_BX().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_EX(struct ::fz_context *arg_0)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_EX().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_OP(struct ::fz_context *arg_0, int arg_2)
{
...
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_OPM(struct ::fz_context *arg_0, int arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_gs_OPM().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_gs_UseBlackPtComp(struct ::fz_context *arg_0, struct ::pdf_obj *arg_2)
{
	throw std::runtime_error( "Unexpected call of unimplemented virtual_fnptrs fn PdfProcessor2::op_gs_UseBlackPtComp().");
}
/* Default implementation of virtual method. */
FZ_FUNCTION void PdfProcessor2::op_END(struct ::fz_context *arg_0)
{
