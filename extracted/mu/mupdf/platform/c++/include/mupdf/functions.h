...
*/
FZ_FUNCTION void ll_fz_bitmap_details(::fz_bitmap *bitmap, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *w
...
*/
FZ_FUNCTION size_t ll_fz_buffer_extract(::fz_buffer *buf, 
		#ifdef SWIG
...
*/
FZ_FUNCTION size_t ll_fz_buffer_storage(::fz_buffer *buf, 
		#ifdef SWIG
			unsigned char **OUTPUT
		#else
			unsigned char **datap
...
*/
FZ_FUNCTION int ll_fz_chartorune(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *rune
...
/**
	...
	given colorspace.
*/
FZ_FUNCTION void ll_fz_clamp_color(::fz_colorspace *cs, const float *in, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *out
...
*/
FZ_FUNCTION void ll_fz_convert_color(::fz_colorspace *ss, const float *sv, ::fz_colorspace *ds, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *dv
...
*/
FZ_FUNCTION void ll_fz_convert_separation_colors(::fz_colorspace *src_cs, const float *src_color, ::fz_separations *dst_seps, ::fz_colorspace *dst_cs, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *dst_color
...
*/
FZ_FUNCTION ::fz_pixmap *ll_fz_decomp_image_from_stream(::fz_stream *stm, ::fz_compressed_image *image, ::fz_irect *subarea, int indexed, int l2factor, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *l2extra
...
/**
	...
	*compressed_length will be updated on exit to contain the size
	actually used.
 */
FZ_FUNCTION void ll_fz_deflate(unsigned char *dest, 
		#ifdef SWIG
			size_t *OUTPUT
		#else
...
*/
FZ_FUNCTION const char *ll_fz_dom_get_attribute(::fz_xml *elt, int i, 
		#ifdef SWIG
			const char **OUTPUT
		#else
			const char **att
...
*/
FZ_FUNCTION int ll_fz_drop_imp(void *p, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *refs
...
*/
FZ_FUNCTION int ll_fz_drop_imp16(void *p, 
		#ifdef SWIG
			int16_t *OUTPUT
		#else
			int16_t *refs
...
*/
FZ_FUNCTION int ll_fz_encode_character_with_fallback(::fz_font *font, int unicode, int script, int language, 
		#ifdef SWIG
			::fz_font **OUTPUT
		#else
			::fz_font **out_font
...
/**
	...
	the caller.
*/
FZ_FUNCTION ::fz_error_cb *ll_fz_error_callback(
		#ifdef SWIG
			void **OUTPUT
		#else
			void **user
...
*/
FZ_FUNCTION void ll_fz_fill_pixmap_with_color(::fz_pixmap *pix, ::fz_colorspace *colorspace, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *color
...
*/
FZ_FUNCTION ::fz_pixmap *ll_fz_get_pixmap_from_image(::fz_image *image, const ::fz_irect *subarea, ::fz_matrix *ctm, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *w
...
*/
FZ_FUNCTION int ll_fz_getopt(int nargc, 
		#ifdef SWIG
			char **OUTPUT
		#else
			char **nargv
...
*/
FZ_FUNCTION int ll_fz_grisu(float f, char *s, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *exp
...
*/
FZ_FUNCTION int ll_fz_has_option(const char *opts, const char *key, 
		#ifdef SWIG
			const char **OUTPUT
		#else
			const char **val
...
/**
	...
	if not encoded).
*/
FZ_FUNCTION void ll_fz_image_resolution(::fz_image *image, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *xres
...
*/
FZ_FUNCTION void *ll_fz_keep_imp(void *p, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *refs
...
*/
FZ_FUNCTION void *ll_fz_keep_imp16(void *p, 
		#ifdef SWIG
			int16_t *OUTPUT
		#else
			int16_t *refs
...
*/
FZ_FUNCTION void *ll_fz_keep_imp_locked(void *p, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *refs
...
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_base14_font(const char *name, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_builtin_font(const char *name, int bold, int italic, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_cjk_font(int ordering, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_cjk_font_by_language(const char *lang, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_noto_emoji_font(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
/**
	...
	Returns a pointer to the font file data, or NULL if not present.
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_noto_font(int script, int lang, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
/**
	...
	configuration in which MuPDF is built.
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_noto_math_font(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_noto_music_font(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_noto_symbol1_font(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
*/
FZ_FUNCTION const unsigned char *ll_fz_lookup_noto_symbol2_font(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
*/
FZ_FUNCTION unsigned char *ll_fz_new_deflated_data(
		#ifdef SWIG
			size_t *OUTPUT
		#else
			size_t *compressed_length
...
/**
	...
	down if it wants to.
*/
FZ_FUNCTION unsigned char *ll_fz_new_deflated_data_from_buffer(
		#ifdef SWIG
			size_t *OUTPUT
		#else
			size_t *compressed_length
...
*/
FZ_FUNCTION ::fz_display_list *ll_fz_new_display_list_from_svg(::fz_buffer *buf, const char *base_uri, ::fz_archive *zip, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *w
...
/**
	Parse an SVG document into a display-list.
*/
FZ_FUNCTION ::fz_display_list *ll_fz_new_display_list_from_svg_xml(::fz_xml_doc *xmldoc, ::fz_xml *xml, const char *base_uri, ::fz_archive *zip, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *w
...
*/
FZ_FUNCTION ::fz_device *ll_fz_new_draw_device_with_options(const ::fz_draw_options *options, ::fz_rect mediabox, 
		#ifdef SWIG
			::fz_pixmap **OUTPUT
		#else
			::fz_pixmap **pixmap
...
*/
FZ_FUNCTION ::fz_image *ll_fz_new_image_from_compressed_buffer(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *decode
...
*/
FZ_FUNCTION ::fz_image *ll_fz_new_image_of_size(int w, int h, int bpc, ::fz_colorspace *colorspace, int xres, int yres, int interpolate, int imagemask, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *decode
...
*/
FZ_FUNCTION ::fz_device *ll_fz_new_svg_device_with_id(::fz_output *out, float page_width, float page_height, int text_format, int reuse_images, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *id
...
*/
FZ_FUNCTION ::fz_device *ll_fz_new_test_device(
		#ifdef SWIG
			int *OUTPUT
		#else
			int *is_color
...
*/
FZ_FUNCTION ::fz_stream *ll_fz_open_image_decomp_stream(::fz_stream *arg_1, ::fz_compression_params *arg_2, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *l2factor
...
*/
FZ_FUNCTION ::fz_stream *ll_fz_open_image_decomp_stream_from_buffer(::fz_compressed_buffer *arg_1, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *l2factor
...
*/
FZ_FUNCTION size_t ll_fz_pack_path(uint8_t *pack, size_t max, const ::fz_path *path);
...
*/
FZ_FUNCTION ::fz_transition *ll_fz_page_presentation(::fz_page *page, ::fz_transition *transition, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *duration
...
/**
	...
	ignored.
*/
FZ_FUNCTION void ll_fz_paint_shade(::fz_shade *shade, ::fz_colorspace *override_cs, ::fz_matrix ctm, ::fz_pixmap *dest, ::fz_color_params color_params, ::fz_irect bbox, const ::fz_overprint *eop, 
		#ifdef SWIG
...
*/
FZ_FUNCTION const char *ll_fz_parse_page_range(const char *s, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *a
...
*/
FZ_FUNCTION ::fz_buffer *ll_fz_read_best(::fz_stream *stm, size_t initial, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *truncated
...
*/
FZ_FUNCTION int ll_fz_search_chapter_page_number(::fz_document *doc, int chapter, int page, const char *needle, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *hit_mark
...
*/
FZ_FUNCTION int ll_fz_search_display_list(::fz_display_list *list, const char *needle, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *hit_mark
...
*/
FZ_FUNCTION int ll_fz_search_page(::fz_page *page, const char *needle, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *hit_mark
...
*/
FZ_FUNCTION int ll_fz_search_page_number(::fz_document *doc, int number, const char *needle, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *hit_mark
...
/**
	...
	without notice.
*/
FZ_FUNCTION int ll_fz_search_stext_page(::fz_stext_page *text, const char *needle, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *hit_mark
...
*/
FZ_FUNCTION void ll_fz_separation_equivalent(const ::fz_separations *seps, int idx, ::fz_colorspace *dst_cs, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *dst_color
...
*/
FZ_FUNCTION int ll_fz_store_scavenge(size_t size, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *phase
...
/**
	...
	Returns non zero if we managed to free any memory.
*/
FZ_FUNCTION int ll_fz_store_scavenge_external(size_t size, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *phase
...
/**
	...
	"NAN", "INF" or "INFINITY".
*/
FZ_FUNCTION float ll_fz_strtof(const char *s, 
		#ifdef SWIG
			char **OUTPUT
		#else
			char **es
...
/**
	...
	the caller.
*/
FZ_FUNCTION ::fz_warning_cb *ll_fz_warning_callback(
		#ifdef SWIG
			void **OUTPUT
		#else
			void **user
...
*/
FZ_FUNCTION void ll_pdf_annot_MK_BC(::pdf_annot *annot, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *n
...
*/
FZ_FUNCTION void ll_pdf_annot_MK_BG(::pdf_annot *annot, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *n
...
*/
FZ_FUNCTION void ll_pdf_annot_color(::pdf_annot *annot, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *n
...
*/
FZ_FUNCTION void ll_pdf_annot_default_appearance(::pdf_annot *annot, 
		#ifdef SWIG
			const char **OUTPUT
		#else
			const char **font
...
*/
FZ_FUNCTION void ll_pdf_annot_interior_color(::pdf_annot *annot, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *n
...
*/
FZ_FUNCTION void ll_pdf_annot_line_ending_styles(::pdf_annot *annot, 
		#ifdef SWIG
...
*/
FZ_FUNCTION const char *ll_pdf_array_get_string(::pdf_obj *array, int index, 
		#ifdef SWIG
			size_t *OUTPUT
		#else
			size_t *sizep
...
FZ_FUNCTION char *ll_pdf_crypt_method(::pdf_crypt *crypt);
...
*/
FZ_FUNCTION int ll_pdf_decode_cmap(::pdf_cmap *cmap, unsigned char *s, unsigned char *e, 
		#ifdef SWIG
			unsigned int *OUTPUT
		#else
			unsigned int *cpt
...
*/
FZ_FUNCTION void ll_pdf_dict_get_put_drop(::pdf_obj *dict, ::pdf_obj *key, ::pdf_obj *val, 
		#ifdef SWIG
			::pdf_obj **OUTPUT
		#else
			::pdf_obj **old_val
...
*/
FZ_FUNCTION const char *ll_pdf_dict_get_string(::pdf_obj *dict, ::pdf_obj *key, 
		#ifdef SWIG
			size_t *OUTPUT
		#else
			size_t *sizep
...
*/
FZ_FUNCTION int ll_pdf_edit_text_field_value(::pdf_annot *widget, const char *value, const char *change, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *selStart
...
*/
FZ_FUNCTION void ll_pdf_eval_function(::pdf_function *func, const float *in, int inlen, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *out
...
*/
FZ_FUNCTION int ll_pdf_field_event_validate(::pdf_document *doc, ::pdf_obj *field, const char *value, 
		#ifdef SWIG
			char **OUTPUT
		#else
			char **newvalue
...
/** Low-level wrapper for `::pdf_field_name()`. */
FZ_FUNCTION char *ll_pdf_field_name(::pdf_obj *field);


/** Alternative to `ll_pdf_field_name()` that returns a std::string. */
FZ_FUNCTION std::string ll_pdf_field_name2(pdf_obj* field);
...
FZ_FUNCTION void ll_pdf_filter_annot_contents(::pdf_document *doc, ::pdf_annot *annot, ::pdf_filter_options *filter);

/** Low-level wrapper for `::pdf_filter_page_contents()`. */
FZ_FUNCTION void ll_pdf_filter_page_contents(::pdf_document *doc, ::pdf_page *page, ::pdf_filter_options *filter);

/** Low-level wrapper for `::pdf_filter_xobject_instance()`. */
FZ_FUNCTION ::pdf_obj *ll_pdf_filter_xobject_instance(::pdf_obj *old_xobj, ::pdf_obj *page_res, ::fz_matrix ctm, ::pdf_filter_options *filter, ::pdf_cycle_list *cycle_up);
...
*/
FZ_FUNCTION int ll_pdf_js_event_result_validate(::pdf_js *js, 
		#ifdef SWIG
			char **OUTPUT
		#else
			char **newvalue
...
*/
FZ_FUNCTION void ll_pdf_js_execute(::pdf_js *js, const char *name, const char *code, 
		#ifdef SWIG
			char **OUTPUT
		#else
			char **result
...
*/
FZ_FUNCTION void ll_pdf_load_encoding(
		#ifdef SWIG
			const char **OUTPUT
		#else
			const char **estrings
...
*/
FZ_FUNCTION void ll_pdf_load_to_unicode(::pdf_document *doc, ::pdf_font_desc *font, 
		#ifdef SWIG
			const char **OUTPUT
		#else
			const char **strings
...
*/
FZ_FUNCTION int ll_pdf_lookup_anchor(::pdf_document *doc, const char *name, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *xp
...
*/
FZ_FUNCTION int ll_pdf_lookup_cmap_full(::pdf_cmap *cmap, unsigned int cpt, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *out
...
*/
FZ_FUNCTION const unsigned char *ll_pdf_lookup_substitute_font(int mono, int serif, int bold, int italic, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *len
...
*/
FZ_FUNCTION void ll_pdf_map_one_to_many(::pdf_cmap *cmap, unsigned int one, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *many
...
/** Low-level wrapper for `::pdf_new_filter_processor()`. */
FZ_FUNCTION ::pdf_processor *ll_pdf_new_filter_processor(::pdf_document *doc, ::pdf_processor *chain, ::pdf_obj *old_res, ::pdf_obj *new_res, int struct_parents, ::fz_matrix transform, ::pdf_filter_options *filter);
...
FZ_FUNCTION ::pdf_processor *ll_pdf_new_run_processor(::fz_device *dev, ::fz_matrix ctm, const char *usage, ::pdf_gstate *gstate, ::fz_default_colorspaces *default_cs, ::fz_cookie *cookie);
...
*/
FZ_FUNCTION int ll_pdf_obj_memo(::pdf_obj *obj, int bit, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *memo
...
*/
FZ_FUNCTION ::fz_transition *ll_pdf_page_presentation(::pdf_page *page, ::fz_transition *transition, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *duration
...
*/
FZ_FUNCTION ::fz_device *ll_pdf_page_write(::pdf_document *doc, ::fz_rect mediabox, 
		#ifdef SWIG
			::pdf_obj **OUTPUT
		#else
			::pdf_obj **presources
...
*/
FZ_FUNCTION void ll_pdf_parse_default_appearance(const char *da, 
		#ifdef SWIG
			const char **OUTPUT
		#else
			const char **font
...
*/
FZ_FUNCTION ::pdf_obj *ll_pdf_parse_ind_obj(::pdf_document *doc, ::fz_stream *f, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *num
...
*/
FZ_FUNCTION ::pdf_obj *ll_pdf_parse_journal_obj(::pdf_document *doc, ::fz_stream *stm, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *onum
...
FZ_FUNCTION void ll_pdf_process_contents(::pdf_processor *proc, ::pdf_document *doc, ::pdf_obj *obj, ::pdf_obj *res, ::fz_cookie *cookie);
...
This function has out-params. Python/C# wrappers look like:
	`ll_pdf_repair_obj(::pdf_document *doc, ::pdf_lexbuf *buf, ::pdf_obj **encrypt, ::pdf_obj **id, ::pdf_obj **page, ::pdf_obj **root)` => `(int, int64_t stmofsp, int stmlenp, int64_t tmpofs)`
*/
FZ_FUNCTION int ll_pdf_repair_obj(::pdf_document *doc, ::pdf_lexbuf *buf, 
		#ifdef SWIG
			int64_t *OUTPUT
		#else
			int64_t *stmofsp
...
*/
FZ_FUNCTION int ll_pdf_resolve_link(::pdf_document *doc, const char *uri, 
		#ifdef SWIG
			float *OUTPUT
		#else
			float *xp
...
*/
FZ_FUNCTION size_t ll_pdf_signature_contents(::pdf_document *doc, ::pdf_obj *signature, 
		#ifdef SWIG
			char **OUTPUT
		#else
			char **contents
...
*/
FZ_FUNCTION char *ll_pdf_sprint_obj(char *buf, size_t cap, 
		#ifdef SWIG
			size_t *OUTPUT
		#else
			size_t *len
...
*/
FZ_FUNCTION const char *ll_pdf_to_string(::pdf_obj *obj, 
		#ifdef SWIG
			size_t *OUTPUT
		#else
			size_t *sizep
...
*/
FZ_FUNCTION int ll_pdf_undoredo_state(::pdf_document *doc, 
		#ifdef SWIG
			int *OUTPUT
		#else
			int *steps
...
*/
FZ_FUNCTION void ll_pdf_walk_tree(::pdf_obj *tree, ::pdf_obj *kid_name, void (*arrive)(::fz_context *, ::pdf_obj *, void *, ::pdf_obj **), void (*leave)(::fz_context *, ::pdf_obj *, void *), void *arg, 
		#ifdef SWIG
			::pdf_obj **OUTPUT
		#else
			::pdf_obj **names
