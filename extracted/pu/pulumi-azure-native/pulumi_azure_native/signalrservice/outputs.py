...
class ServerlessSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Serverless settings.
        :param builtins.int connection_timeout_in_seconds: Gets or sets Client Connection Timeout. Optional to be set.
               Value in seconds.
...
class SignalRCorsSettingsResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Cross-Origin Resource Sharing (CORS) settings.
        :param Sequence[builtins.str] allowed_origins: Gets or sets the list of origins that should be allowed to make cross-origin calls (for example: http://example.com:12345). Use "*" to allow all. If omitted, allow all by default.
        """
...
class SignalRFeatureResponse(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Feature of a resource, which controls the runtime behavior.
        :param builtins.str flag: FeatureFlags is the supported features of Azure SignalR service.
        ...
        :param builtins.str value: Value of the feature flag. See Azure SignalR service document https://docs.microsoft.com/azure/azure-signalr/ for allowed values.
        :param Mapping[str, builtins.str] properties: Optional properties related to this feature.
        """
...
class UpstreamTemplateResponse(dict):
    ...
    def __init__(__self__, *,
                 ...
                 category_pattern: Optional[builtins.str] = None,
                 event_pattern: Optional[builtins.str] = None,
                 hub_pattern: Optional[builtins.str] = None):
        """
        Upstream template item settings. It defines the Upstream URL of the incoming requests.
        The template defines the pattern of the event, the hub or the category of the incoming request that matches current URL template.
        :param builtins.str url_template: Gets or sets the Upstream URL template. You can use 3 predefined parameters {hub}, {category} {event} inside the template, the value of the Upstream URL is dynamically calculated when the client request comes in.
        ...
        :param builtins.str category_pattern: Gets or sets the matching pattern for category names. If not set, it matches any category.
               There are 3 kind of patterns supported:
                   1. "*", it to matches any category name.
                   2. Combine multiple categories with ",", for example "connections,messages", it matches category "connections" and "messages".
                   3. The single category name, for example, "connections", it matches the category "connections".
        :param builtins.str event_pattern: Gets or sets the matching pattern for event names. If not set, it matches any event.
               There are 3 kind of patterns supported:
                   1. "*", it to matches any event name.
                   2. Combine multiple events with ",", for example "connect,disconnect", it matches event "connect" and "disconnect".
                   3. The single event name, for example, "connect", it matches "connect".
        :param builtins.str hub_pattern: Gets or sets the matching pattern for hub names. If not set, it matches any hub.
               There are 3 kind of patterns supported:
    ...
    def category_pattern(self) -> Optional[builtins.str]:
        """
    ...
    def hub_pattern(self) -> Optional[builtins.str]:
        """
