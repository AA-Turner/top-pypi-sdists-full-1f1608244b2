...
class DelegatedSubnetServiceDetailsArgs:
    def __init__(__self__, *,
                 ...
                 allocation_block_prefix_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] allocation_block_prefix_size: Defines prefix size of CIDR blocks allocated to nodes in VnetBlock Mode.
    ...
    def allocation_block_prefix_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def allocation_block_prefix_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DelegatedSubnetServiceDetails(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="allocationBlockPrefixSize")
    def allocation_block_prefix_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Defines prefix size of CIDR blocks allocated to nodes in VnetBlock Mode.
        Delegated subnet's prefix size should be smaller than this by a minimum of 3.
        """
